...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/react-component/ReactComponent.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/react-expo/Expo.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/react-ios/React.framework"
fi
